...
#ifndef INCLUDED_QTGUI_SINK_IMPL_H
#define INCLUDED_QTGUI_SINK_IMPL_H
...
template <class T>
class QTGUI_API sink_impl : public sink<T>
{
private:
...
public:
    ...
    sink_impl(const sink_impl&) = delete;
    sink_impl(sink_impl&&) = delete;
    sink_impl& operator=(const sink_impl&) = delete;
    sink_impl& operator=(sink_impl&&) = delete;
...
#endif /* INCLUDED_QTGUI_SINK_IMPL_H */
