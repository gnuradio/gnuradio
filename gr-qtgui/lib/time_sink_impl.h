...
#ifndef INCLUDED_QTGUI_TIME_SINK_IMPL_H
#define INCLUDED_QTGUI_TIME_SINK_IMPL_H
...
template <class T>
class QTGUI_API time_sink_impl : public time_sink<T>
{
private:
    void initialize();
...
public:
    time_sink_impl(int size,
                   double samp_rate,
                   const std::string& name,
                   unsigned int nconnections,
                   QWidget* parent = NULL);
    ~time_sink_impl() override;
...
#endif /* INCLUDED_QTGUI_TIME_SINK_IMPL_H */
