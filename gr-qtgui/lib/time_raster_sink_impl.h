...
#ifndef INCLUDED_QTGUI_TIME_RASTER_SINK_IMPL_H
#define INCLUDED_QTGUI_TIME_RASTER_SINK_IMPL_H
...
template <class T>
class QTGUI_API time_raster_sink_impl : public time_raster_sink<T>
{
private:
    void initialize();
...
public:
    time_raster_sink_impl(double samp_rate,
                          double rows,
                          double cols,
                          ...
                          int nconnections,
                          QWidget* parent = NULL);
    ~time_raster_sink_impl() override;
...
#endif /* INCLUDED_QTGUI_TIME_RASTER_SINK_IMPL_H */
