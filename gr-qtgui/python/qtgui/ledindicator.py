...
from PyQt5.QtGui import (QBrush, QColor, QFontMetricsF, QPainter, QPen,
                         QRadialGradient)
...
class GrLEDIndicator(gr.sync_block, LabeledLEDIndicator):
    ...
    def msgHandler(self, msg):
        try:
            if pmt.is_bool(msg) or pmt.is_int(msg):
                new_val = pmt.to_python(msg)
            else:
