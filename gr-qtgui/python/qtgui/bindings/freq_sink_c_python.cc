...
void bind_freq_sink_c(py::module& m)
{
    ...
    py::class_<freq_sink_c,
        ...
        .def("exec", &freq_sink_c::exec, D(freq_sink_c, exec))
        ...
        .def("fft_size", &freq_sink_c::fft_size, D(freq_sink_c, fft_size))


        .def("set_fft_average",
             &freq_sink_c::set_fft_average,
             py::arg("fftavg"),
             D(freq_sink_c, set_fft_average))


        .def("fft_average", &freq_sink_c::fft_average, D(freq_sink_c, fft_average))


        .def("set_fft_window",
             &freq_sink_c::set_fft_window,
             py::arg("win"),
        ...
        .def("set_frequency_range",
             &freq_sink_c::set_frequency_range,
             py::arg("centerfreq"),
             py::arg("bandwidth"),
        ...
        .def("set_update_time",
             &freq_sink_c::set_update_time,
             py::arg("t"),
             D(freq_sink_c, set_update_time))


        .def("set_title",
             &freq_sink_c::set_title,
             py::arg("title"),
             D(freq_sink_c, set_title))


        .def("set_y_label",
             &freq_sink_c::set_y_label,
             py::arg("label"),
             py::arg("unit"),
        ...
        .def("title", &freq_sink_c::title, D(freq_sink_c, title))


        .def("line_label",
             &freq_sink_c::line_label,
             py::arg("which"),
             D(freq_sink_c, line_label))


        .def("line_color",
             &freq_sink_c::line_color,
             py::arg("which"),
             D(freq_sink_c, line_color))


        .def("line_width",
             &freq_sink_c::line_width,
             py::arg("which"),
             D(freq_sink_c, line_width))


        .def("line_style",
             &freq_sink_c::line_style,
             py::arg("which"),
             D(freq_sink_c, line_style))


        .def("line_marker",
             &freq_sink_c::line_marker,
             py::arg("which"),
             D(freq_sink_c, line_marker))


        .def("line_alpha",
             &freq_sink_c::line_alpha,
             py::arg("which"),
             D(freq_sink_c, line_alpha))


        .def("set_size",
             &freq_sink_c::set_size,
             py::arg("width"),
             py::arg("height"),
