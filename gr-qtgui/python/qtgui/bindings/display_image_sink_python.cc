...
void bind_display_image_sink(py::module& m)
{
    ...
    py::class_<display_image, gr::sync_block, gr::block, gr::basic_block,
        ...
        .def("exec_",&display_image::exec_,       
            D(display_image,exec_)
        )
        ...
        .def("displayBottomUp",&display_image::displayBottomUp,       
            py::arg("direction"),
