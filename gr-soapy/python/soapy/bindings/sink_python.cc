...
/* BINDTOOL_HEADER_FILE_HASH(ec5ef0411d20675e7b66f2b23cc3ffed)                     */
/***********************************************************************************/
...
void bind_sink(py::module& m)
{
    ...
    py::class_<sink, gr::sync_block, gr::block, gr::basic_block, std::shared_ptr<sink>>(
        ...
        .def("set_gain",
             (void (sink::*)(size_t, float)) & sink::set_gain,
             py::arg("channel"),
             py::arg("gain"),
             D(sink, set_gain, 0))


        .def("DC_offset_support",
             &sink::DC_offset_support,
             py::arg("channel"),
             D(sink, DC_offset_support))


        .def("IQ_balance_support",
             &sink::IQ_balance_support,
             py::arg("channel"),
             D(sink, IQ_balance_support))


        .def("freq_correction_support",
             &sink::freq_correction_support,
             py::arg("channel"),
        ...
        .def("set_gain",
             (void (sink::*)(size_t, std::string const, float)) & sink::set_gain,
             py::arg("channel"),
             py::arg("name"),
             py::arg("gain"),
             D(sink, set_gain, 1))
        ...
        .def("set_frequency",
             (void (sink::*)(size_t, double)) & sink::set_frequency,
             py::arg("channel"),
             py::arg("freq"),
        ...
        .def("set_frequency",
             (void (sink::*)(size_t, std::string const&, double)) & sink::set_frequency,
             py::arg("channel"),
             py::arg("name"),
             py::arg("frequency"),
