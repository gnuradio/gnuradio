...
static void Cut_Calculation_of_the_LTP_parameters P5(
    (st, d, dp, bc_out, Nc_out),
...
)
{
    ...
    for (lambda = 40; lambda <= 120; lambda += 9) {
        ...
        register float E;
        register float S0 = 0, S1 = 0, S2 = 0, S3 = 0, S4 = 0, S5 = 0, S6 = 0, S7 = 0,
                       S8 = 0;
...
static void Cut_Fast_Calculation_of_the_LTP_parameters P5(
    (st, d, dp, bc_out, Nc_out),
    struct gsm_state* st, /*              IN	*/
    register word* d,     /* [0..39]	IN	*/
    register word* dp,    /* [-120..-1]	IN	*/
