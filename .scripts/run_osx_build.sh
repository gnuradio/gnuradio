...
if [[ "${BUILD_WITH_CONDA_DEBUG:-0}" == 1 ]]; then
    ...
    CONDA_SUBDIR="${BUILD_PLATFORM}" conda debug ./.conda/recipe -m ./.ci_support/${CONFIG}.yaml \
        ${EXTRA_CB_OPTIONS:-} \
    ...
    CONDA_SUBDIR="${BUILD_PLATFORM}" conda-build ./.conda/recipe -m ./.ci_support/${CONFIG}.yaml \
