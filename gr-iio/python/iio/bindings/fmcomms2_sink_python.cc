...
/* BINDTOOL_HEADER_FILE_HASH(5467e27a31722b2c82282460826e32df)                     */
/***********************************************************************************/
...
{
    bind_fmcomms2_sink_template<std::int16_t>(m, "fmcomms2_sink_s");
    bind_fmcomms2_sink_template<gr_complex>(m, "fmcomms2_sink_c");
}
