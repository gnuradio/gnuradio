...
/*!
  ...
  \param num_points Number of points for which cosine is to be computed
*/
static inline void volk_32f_cos_32f_a_generic(float* bVector, const float* aVector, unsigned int num_points){    
    float* bPtr = bVector;
    const float* aPtr = aVector;
    unsigned int number = 0;
...
/*!
  ...
  \param num_points Number of points for which cosine is to be computed
*/
static inline void volk_32f_cos_32f_u_generic(float* bVector, const float* aVector, unsigned int num_points){    
    float* bPtr = bVector;
    const float* aPtr = aVector;
    unsigned int number = 0;
