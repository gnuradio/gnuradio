...
*/
static inline void volk_32f_x2_pow_32f_a_generic(float* cVector, const float* bVector, const float* aVector, unsigned int num_points){    
    float* cPtr = cVector;
...
/*!
  ...
  \param num_points Number of points for which pow is to be computed
*/
static inline void volk_32f_x2_pow_32f_u_generic(float* cVector, const float* bVector, const float* aVector, unsigned int num_points){    
    float* cPtr = cVector;
    const float* bPtr = bVector;
    const float* aPtr = aVector;
    unsigned int number = 0;
