...
m4_include([config/ax_boost_unit_test_framework.m4])
m4_include([config/cppunit.m4])
m4_include([config/gcc_version_workaround.m4])
...
m4_include([config/lv_set_simd_flags.m4])
m4_include([config/orc.m4])
