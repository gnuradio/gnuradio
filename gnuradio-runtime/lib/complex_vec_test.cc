...
std::vector<std::complex<float> > complex_vec_test0()
{
...
std::complex<float> complex_scalar_test0() { return std::complex<float>(5, 5); }

std::complex<float> complex_scalar_test1(std::complex<float> input)
{
    return std::complex<float>(input.real() + 0.5, input.imag() - 0.5);
}


std::vector<float> float_vec_test0()
{
...
std::vector<float> float_vec_test1(const std::vector<float>& input)
{
...
std::vector<int> int_vec_test1(const std::vector<int>& input)
{
