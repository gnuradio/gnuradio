...
void bind_control_loop(py::module& m)
{
    ...
    using control_loop = ::gr::kernel::math::control_loop;
    ...
    py::class_<control_loop, std::shared_ptr<control_loop>>(
        ...
        .def(py::init<gr::kernel::math::control_loop const&>(),
             py::arg("arg0"),
    ...
    m.def("tanhf_lut", &::gr::kernel::math::tanhf_lut, py::arg("x"), D(tanhf_lut));
}
