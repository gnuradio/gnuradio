...
TOGGLE_SHOW_PARAMETER_EXPRESSION = actions.register( "win.show_param_expression",
...
TOGGLE_SHOW_PARAMETER_EVALUATION = actions.register( "win.show_param_expression_value",
