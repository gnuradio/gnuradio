...
class BlockTreeWindow(Gtk.VBox):
    ...
    def _update_search_tree(self, widget):
        ...
        if not key:
            ...
            matching_blocks = [
                b for b in list(self.platform.blocks.values()) if key in b.key.lower() or key in b.label.lower()
            ]
    ...
    def _handle_search_key_press(self, widget, event):
        ...
        if event.keyval == Gdk.KEY_Return:
            ...
            event.get_state() & Gdk.ModifierType.CONTROL_MASK and event.keyval == Gdk.KEY_f
