...
class Config(CoreConfig):
    ...
    def flowgraph_grid_mode(self):
        # Load from the user settings (not the autogenerated config file)
        return self._gr_prefs.get_string('grc', 'flowgraph_grid_mode', 'lines')
    
    def flowgraph_grid_size(self):
        # Load the number of 'points' to represent the flowgraph grid
        return int(self._gr_prefs.get_string('grc', 'flowgraph_grid_size', Constants.CANVAS_GRID_SIZE))
