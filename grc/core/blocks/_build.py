...
def build(id, label='', category='', flags='', documentation='',
          ...
          parameters=None, ports=None, inputs=None, outputs=None, templates=None, cpp_templates=None, **kwargs):
    block_id = id
    ...
    # GR 4.0 blocks have ports category, not separate inputs and outputs fields
