...
%template(adaptive_algorithm_sptr) boost::shared_ptr<gr::digital::adaptive_algorithm>;

%template(adaptive_algorithm_lms_sptr) boost::shared_ptr<gr::digital::adaptive_algorithm_lms>;
%pythoncode %{
...
%}
%template(adaptive_algorithm_nlms_sptr) boost::shared_ptr<gr::digital::adaptive_algorithm_nlms>;
%pythoncode %{
...
%}
%template(adaptive_algorithm_cma_sptr) boost::shared_ptr<gr::digital::adaptive_algorithm_cma>;
%pythoncode %{
