...
{
public:
    using sptr = std::shared_ptr<ofdm_carrier_allocator_cvc>;
     ...
     * \param output_is_shifted whether to 'fftshift' the output OFDM symbols. If used,
     * the followup FFT should be instantaited such that it knows that the input is
     * shifted. Default is true.
     */
