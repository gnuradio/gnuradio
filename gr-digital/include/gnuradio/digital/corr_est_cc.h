...
public:
     ...
     *                          For ABSOLUTE threshold method, this parameter sets the threshold to a
     *                          fraction of the maximum squared autocorrelation. 
     *                          The code performs the check |r[k]|^2 <> threshold * R^2, 
     *                          where R is the precomputed max autocorrelation of the given sync word. 
     *                          Default is 0.9 
