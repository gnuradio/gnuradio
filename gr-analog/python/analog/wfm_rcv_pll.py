...
class wfm_rcv_pll(gr.hier_block2):
    def __init__(self, demod_rate, audio_decimation, deemph_tau):
        ...
        self.samp_delay = samp_delay = (len(
            stereo_carrier_filter_coeffs) - 1) // 2 + (len(stereo_carrier_filter_coeffs_0) - 1) // 2
        ...
        self.fft_filter_xxx_2 = filter.fft_filter_fff(
            audio_decim, audio_filter, 1)
        self.fft_filter_xxx_2.declare_sample_delay(0)
        self.fft_filter_xxx_1 = filter.fft_filter_fff(
            audio_decim, audio_filter, 1)
        ...
        self.analog_fm_deemph_0_0 = analog.fm_deemph(
