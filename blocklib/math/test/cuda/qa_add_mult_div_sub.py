...
class test_add_mult_div_sub(gr_unittest.TestCase):
    ...
    def test_add_ss(self):
        ...
        op = math.add_ss(2, impl=math.add_ss.cuda)
    ...
    def test_add_ii(self):
        ...
        src2_data = [8, -3, 4, 8, 2]
        expected_result = [9, -1, 7, 12, 7]
        op = math.add_ii(2, impl=math.add_ii.cuda)
    ...
    def test_add_ff(self):
        ...
        op = math.add_ff(2, impl=math.add_ff.cuda)
    ...
    def test_add_cc(self):
        ...
        op = math.add_cc(2, impl=math.add_cc.cuda)
