...
freq_xlating_fir_filter_cpu<IN_T, OUT_T, TAP_T>::freq_xlating_fir_filter_cpu(
...
template <class IN_T, class OUT_T, class TAP_T>
void freq_xlating_fir_filter_cpu<IN_T, OUT_T, TAP_T>::on_parameter_change(
    param_action_sptr action)
{
    ...
    if (action->id() == freq_xlating_fir_filter<IN_T, OUT_T, TAP_T>::id_taps) {
        ...
        d_updated = true;
             ...
             freq_xlating_fir_filter<IN_T, OUT_T, TAP_T>::id_center_freq) {
        d_updated = true;
    }
}
