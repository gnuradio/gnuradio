...
public:
    ...
    using sptr = std::shared_ptr<sccc_decoder_blk<T>>;
...
using sccc_decoder_b = sccc_decoder_blk<std::uint8_t>;
using sccc_decoder_s = sccc_decoder_blk<std::int16_t>;
using sccc_decoder_i = sccc_decoder_blk<std::int32_t>;
} /* namespace trellis */
} /* namespace gr */
