# ------------------------------------------------------------------------------
#  Android CMake toolchain file, for use with the Android NDK r8e
#  Based on original android cmake toolchain from:
#  http://code.opencv.org/projects/opencv/repository/revisions/master/entry/platforms/android/android.toolchain.cmake
#  Modified by Douglas Geiger <doug.geiger@bioradiation.net>
...
set( ANDROID_SUPPORTED_NDK_VERSIONS ${ANDROID_EXTRA_NDK_VERSIONS} -r8e -r10d "" )
set( ANDROID_SUPPORTED_ABIS_arm "armeabi-v7a;armeabi;armeabi-v7a with NEON;armeabi-v7a with VFPV3;armeabi-v6 with VFP" )
set( ANDROID_SUPPORTED_ABIS_x86 "x86" )
set( ANDROID_SUPPORTED_ABIS_mipsel "mips" )

set( ANDROID_DEFAULT_NDK_API_LEVEL 21 )
set( ANDROID_DEFAULT_NDK_API_LEVEL_x86 14 )
set( ANDROID_DEFAULT_NDK_API_LEVEL_mips 14 )
set( ANDROID_SUPPORTED_ABIS_arm "armeabi-v7a;armeabi;armeabi-v7a with NEON;armeabi-v7a with VFPV3;armeabi-v6 with VFP" )
set( ANDROID_SUPPORTED_ABIS_x86 "x86" )
set( ANDROID_SUPPORTED_ABIS_mipsel "mips" )
...
To configure the toolchain set CMake variable ANDROID_TOOLCHAIN_NAME to one of the following values:\n${toolchains_list}\n" )
 ...
 list( LENGTH __availableToolchainArchs __availableToolchainsArchsCount )
 if( __availableToolchainsArchsCount LESS __availableToolchainsCount)
    set(__availableToolchainsCount ${__availableToolchainsArchsCount})
 endif()
...
if( ARMEABI_V7A )
 ...
 if( NEON )
  set( ANDROID_CXX_FLAGS "${ANDROID_CXX_FLAGS} -mfpu=neon -march=armv7-a" )
 elseif( VFPV3 )
...
set( CMAKE_EXE_LINKER_FLAGS    "-Wl,--dynamic-linker=/system/bin/linker ${ANDROID_LINKER_FLAGS} ${CMAKE_EXE_LINKER_FLAGS}" )

message(STATUS "-->>> Android C Flags: ${ANDROID_CXX_FLAGS}")
