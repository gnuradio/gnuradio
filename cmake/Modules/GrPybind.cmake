...
macro(GR_PYBIND_MAKE name updir filter files)
    ...
    configure_file(${CMAKE_SOURCE_DIR}/docs/doxygen/pydoc_macros.h
    ...
    if(ENABLE_DOXYGEN)
        add_custom_command(
            ...
            COMMAND
                ${PYTHON_EXECUTABLE} ${CMAKE_SOURCE_DIR}/docs/doxygen/update_pydoc.py
                "sub" "--json_path"
                ${CMAKE_BINARY_DIR}/docs/doxygen/gnuradio_docstrings.json "--bindings_dir"
                ${CMAKE_CURRENT_SOURCE_DIR}/docstrings "--output_dir"
...
macro(GR_PYBIND_MAKE_CHECK_HASH name updir filter files)
    ...
    foreach(file ${files})
        ...
        execute_process(
            COMMAND
                "${PYTHON_EXECUTABLE}"
                ${CMAKE_SOURCE_DIR}/gr-utils/bindtool/scripts/header_utils.py "all"
                ...
                if(flag_auto STREQUAL "False"
                    ...
                    add_custom_command(
                        ...
                        COMMAND
                            ...
                            ${CMAKE_INSTALL_PREFIX} "--src" ${CMAKE_SOURCE_DIR} "--module"
                            ${name} "--filename" ${header_full_path} "--status"
...
macro(GR_PYBIND_MAKE_OOT name updir filter files)
    ...
    if(ENABLE_DOXYGEN)
        ...
        add_custom_command(
            ...
            COMMAND
                ${PYTHON_EXECUTABLE} ${CMAKE_SOURCE_DIR}/docs/doxygen/update_pydoc.py
                "scrape" "--xml_path" ${CMAKE_BINARY_DIR}/docs/doxygen/xml "--json_path"
