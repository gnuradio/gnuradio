...
function(GR_UNIQUE_TARGET desc)
    file(RELATIVE_PATH reldir ${GNURADIO_BINARY_DIR} ${CMAKE_CURRENT_BINARY_DIR})
...
function(GR_PYTHON_INSTALL)
    ...
    install(
      ...
      ${GR_PYTHON_INSTALL_UNPARSED_ARGUMENTS}
        ...
        add_custom_command(
            ...
            COMMAND ${PYTHON_EXECUTABLE} ${GNURADIO_BINARY_DIR}/python_compile_helper.py ${pysrcfiles} ${pycfiles}
        )

        #the command to generate the pyo files
        add_custom_command(
            DEPENDS ${pysrcfiles} OUTPUT ${pyofiles}
            COMMAND ${PYTHON_EXECUTABLE} -O ${GNURADIO_BINARY_DIR}/python_compile_helper.py ${pysrcfiles} ${pyofiles}
        )
    ...
    ####################################################################
        ...
        foreach(pyfile ${GR_PYTHON_INSTALL_PROGRAMS})
            ...
            get_filename_component(pyfile ${pyfile} ABSOLUTE)
            string(REPLACE "${GNURADIO_SOURCE_DIR}" "${GNURADIO_BINARY_DIR}" pyexefile "${pyfile}.exe")
...
########################################################################
file(WRITE ${GNURADIO_BINARY_DIR}/python_compile_helper.py "
