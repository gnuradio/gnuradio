...
class TestModToolCore(unittest.TestCase):
    ...
    def test_add(self):
        ...
        self.assertTrue(path.exists(
            path.join(module_dir, 'include', 'howto', 'add_ff.h')))
        ...
        test_obj.run()
        self.assertTrue(path.exists(
            path.join(module_dir, 'python', 'mul_ff.py')))
        self.assertTrue(path.exists(
            path.join(module_dir, 'python', 'qa_mul_ff.py')))
        self.assertTrue(path.exists(
    ...
    def test_rename(self):
        ...
        self.assertTrue(path.exists(
            path.join(module_dir, 'python', 'qa_div_ff.py')))
        self.assertTrue(path.exists(
        ...
        self.assertTrue(path.exists(
            path.join(module_dir, 'python', 'qa_sub_ff.py')))
        self.assertTrue(path.exists(
    ...
    def test_remove(self):
        ...
        self.assertTrue(path.exists(
            path.join(module_dir, 'python', 'qa_square_ff.py')))
        self.assertTrue(path.exists(
